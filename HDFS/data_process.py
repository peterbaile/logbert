...
def generate_train_test(hdfs_sequence_file, n=None, n_normal=None, n_abnormal=None, normal_ratio=0.03, abnormal_ratio=0.1):
    blk_label_dict = {}
    ...
    train_normal_len = n_normal if n_normal else int(normal_len * normal_ratio)
    train_abnormal_len = n_abnormal if n_abnormal else int(abnormal_len * abnormal_ratio)
...
if __name__ == "__main__":
    ...
    generate_train_test(log_sequence_file, n_normal=2500, n_abnormal=7500)
